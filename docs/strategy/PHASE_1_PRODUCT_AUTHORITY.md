...
This document is the single canonical Phase 1 product and commercial authority for Pyrnova. It supersedes any prior Phase 1 product or commercial authority that conflicts with it. Any current reference to `docs/strategy/PRODUCT_COMMERCIAL_AUTHORITY.md` must resolve here. No peer `PRODUCT_COMMERCIAL_AUTHORITY.md` authority exists on `main`.
...
Where an older document conflicts with this Constitution, this document controls at the current-product/strategic-authority level.
