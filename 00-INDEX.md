...
- `docs/strategy/CORPORATE_POSTURE_AND_BRAND.md` — two-faces posture, customer voice (with D-041),
  ...
  parent/product hierarchy, cyan-led accent system, semantic product colors, typography classes, current
  working master-logo authority, and open subproduct-mark/imagery boundaries (D-054/D-069/D-070). The
  pending canonical master-asset requirement is recorded under `docs/brand/master/`.
